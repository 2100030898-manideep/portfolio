      ...
      <section className="card-section home-card">
        <div className="profile">
          ...
          <div className="social">
            <a
              className="link"
              href="https://github.com/2100030898-manideep"
              rel="noreferrer"
              target="_blank"
              aria-label="github"
            ...
            >
             ...
             <a
              className="link"
              href="https://www.linkedin.com/in/mani-deep/"
              rel="noreferrer"
              target="_blank"
              aria-label="linkedin"
            ...
            <a
              className="link"
              href="https://www.facebook.com/share/1K7vtnSMWL/"
              rel="noreferrer"
              target="_blank"
              aria-label="facebook"
            ...
            <a
              className="link"
              href="https://www.instagram.com/mani.__.deep?igsh=ZmF6NDdkang5Yzc2"
              rel="noreferrer"
              target="_blank"
