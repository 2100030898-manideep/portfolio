            ...
            <div className="row">
              <div className="col col-6 border-line-v">
                <div className="text-box"  data-aos="fade-up">
                  <p>
                    <b>I'm</b>{" "} {new Date().getFullYear() <=2024 ? ` a ${new Date().getFullYear() - 2020}${new Date().getFullYear() < 4 ? "th" : "rd" } year B.tech student pursuing ` : "recent graduated"}
                     Computer Science and Engineering student from KL University with a strong passion for technology and innovation. During my academic journey, I built a solid foundation in programming, algorithms, and data structures. Beyond coursework, I actively engaged in hands-on projects, which helped me enhance my practical skills and deepen my knowledge.
                  </p>
                </div>
              </div>
              <div className="col col-6 border-line-v">
                <div className="info-list"  data-aos="fade-up">
                  <ul>
                    ...
                    <li>
                      <strong>Birthday: </strong>05 March 2004
                    </li>
                    <li>
                      <strong>Hometown: </strong>Jangareddygudem, AndhraPradesh
                    </li>
                    <li>
                      <strong>Gmail: </strong>2100030898cseh@gmail.com
                    </li>
                    <li>
                      <strong>Residence: </strong>AndhraPradesh, India
                    </li>
                  </ul>
                </div>
              </div>
